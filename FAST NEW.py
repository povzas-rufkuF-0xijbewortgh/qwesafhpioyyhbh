...
os.system('clear')
cetak(nel('\t• LUCFER Tool Is running ...•'))
...
'''
	...
	print(('—'*25)+'\n• LUCFER XO•\n'+('—'*25))
	cetak(nel(لوغو+لوغوكيلوا,style='red'))
	print(('—'*25)+'\n• LUCFER XO•\n'+('—'*25))

	cetak(nel(f'''{تزيين}
{ارجواني}ʚ[1]ɞ - {اخضر}Crack IDs • {احمرثاني} صيد من ايديات
{تزيين}
{ارجواني}ʚ[2]ɞ - {اخضر}Crack File • {احمر} صيد من ملف
{تزيين}
{ارجواني}ʚ[0]ɞ - {احمر}Log Out • تسجيل خروج 
{تزيين}''',style='green',title='اهلا وسهلا '))
...
def kil_vip_file():
	...
	try:
		...
		jum = input('{ارجواني} • File Name •{اخضر} اسم او مسار الملف : ')
